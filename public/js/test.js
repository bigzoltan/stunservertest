...
const registerSocketEvents = (socket) => {
  ...
  socket.on("IceCandidate", (data) => {
    ...
    console.log("Candidate recived =>", data);
  });
...
const testSendOffer = async () => {
  ...
  console.log("Offer Sent =>", SDPOffer);
...
let createOffer = async () => {
  ...
  peerConnection.onicecandidate = async (event) => {
    if (event.candidate) {
      ...
      console.log("Offer side candidate sending => ", event.candidate);
      ...
      socketIo.emit("ServerOfferIceCandidate", OfferCandidate);
    }
  };
